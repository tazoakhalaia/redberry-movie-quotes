...
<div class="w-28 flex justify-center items-center">
    <div class="ml-2">
        <button class="block rounded-full text-white border border-slate-100 hover:bg-white hover:text-black">{{__('profile.ka')}}</button>
        <button class="rounded-full text-white border border-slate-100 hover:bg-white hover:text-black mt-2">{{__('profile.en')}}</button>
    </div>
</div>
